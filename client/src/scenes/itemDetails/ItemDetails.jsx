  ...
  return (
    ...
    <div className="w-full h-auto px-10 md:px-10 xl:px-28 mb-20">
      ...
      <div className="h-full flex flex-col md:flex-row justify-center mt-2">
        ...
        <div className=" w-full max-w-[500px] md:max-w-[400px] lg:max-w-[500px] h-[730px] relative p-1 border rounded-md border-black">
        {item && <img
              alt={item.name}
              className="w-full h-full object-contain"
              /* ${constants.backendUrl}*/
              src={`${item.attributes.images.data[currentImageIndex].attributes.url}`}
          ...
          <div className="w-full flex flex-row justify-between mt-4 max-w-[500px] md:max-w-[400px] lg:max-w-[500px]">
        ...
        <div className=" lg:pl-20 md:pl-10 max-w-[500px] md:max-w-[400px] lg:max-w-[500px]">

          <div className=" h-auto pb-6  max-w-[500px] border-b border-[#E8ECEF]">
...
#6C7275]">{item && item.attributes.longDescription[0].children[0].text}</div>
          ...
          <div id="measurements" className="mt-4 h-[60px] mb-6">
                ...
                <div id="images" className="flex flex-row gap-x-4 my-2 flex-wrap mb-6">
                  {item.attributes.optionsProduct.optionsProduct[key].map((option, index) => (
                    ...
                    >
                      ...
                      className="w-full h-full object-contain"
                      /* ${constants.backendUrl}*/
                      src={`${item.attributes.optionsimages.data[index].attributes.url}`}
          ...
          <div id="Add" className="flex flex-row">
            <div id="counter" className="h-[55px] w-[130px] mr-14 bg-[#F5F5F5] rounded-lg flex flex-row items-center">
              <MdRemove className="flex-1 cursor-pointer" onMouseDown={(e) => e.preventDefault()} onClick={() => setCount(Math.max(count - 1, 1))}/>   
              <div className="flex-1 text-center">{count}</div>           
              <MdAdd  className="flex-1 cursor-pointer" onMouseDown={(e) => e.preventDefault()} onClick={() => setCount(count + 1)}/>
          ...
          <div id="cart" >
            <div className="mt-6 bg-black h-[55px]  flex justify-center items-center rounded-lg text-white text-[18px] font-bold cursor-pointer" style={{ fontFamily: 'Inter, sans-serif'}} onClick={handleAddToCart} onMouseDown={(e) => e.preventDefault()}>
              Add to Cart
            </div>
            <div className="mt-6 bg-[#38C172] h-[55px] w-full flex justify-center items-center rounded-lg text-white text-[18px] font-bold cursor-pointer" onClick={handleCheckout}>
              Checkout
            </div>
          </div>

          <div id="precisedesc" className=" mt-8 border-t border-[#E8ECEF] w-auto h-auto pt-5">
