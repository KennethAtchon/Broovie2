...
const Banner = () => {
  ...
  return (
    <div className="w-full h-[40px] bg-[#3C403D]">
      <div className="w-full h-full flex justify-center items-center text-white cursor-pointer hover:text-[#B88E2F]" onClick={() => navigate("/shop")}>
        Most Items Are 10% off or more. Buy Now!
      </div>
    </div>
  );
};
              ...
              <div className="relative bg-white w-40 h-full shadow-lg">
                ...
                >
                  ...
                  <div
                      onClick={() => {
                        navigate("/about");
                        toggleMenu(); // Close the menu when clicking About
                      }}
                  ...
                  <div
                      onClick={() => {
                        navigate("/contact");
                        toggleMenu(); // Close the menu when clicking Contact
                      }}
                      className="hover:text-blue-500 hover:bg-gray-200 p-2 rounded transition-colors duration-200"
                    >
                      <b>Contact</b>
