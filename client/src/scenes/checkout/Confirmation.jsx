...
const Confirmation = () => {
  ...
  return (
    <div className='h-[500px] px-0 md:px-40 py-16 flex flex-col items-center'>
      <div className='h-full max-w-[80%] md:max-w-[90%] border border-black rounded-lg shadow-lg flex flex-col items-center'>
