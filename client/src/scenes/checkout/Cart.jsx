...
const Cart = ({ handleNextStep }) => {
  ...
  useEffect(() => {
    if (cart && selectedShipping) {
      const selectedShippingCost = cart[0].attributes.shippingDetails.shippingDetails[selectedShipping].shippingCost;
  ...
  return (
    <div className=" w-full h-full flex flex-col ">
      ...
      {/* 485px */}
      <div id="cartitems" className="flex flex-col md:flex-row items-center md:justify-between my-12 h-auto gap-x-4 lg:gap-x-16">
        {/* w-[645px] */}
        <div id="products" className=" w-auto ">
           <div className='flex flex-row justify-between pb-5 border-b border-[#6C7275]'>
            <div>Product</div>   

            <div className='flex flex-row justify-between w-[250px] lg:w-[325px]'>
              <div>Quantity</div>
              <div>Price</div>
              <div>Subtotal</div>              
            </div>
              ...
              return (
                <div key={item.id} id="item" className="flex flex-row justify-between my-4 border-b pb-3">
                  <div className="h-24 flex flex-row items-center">
                    <div id="image" className="h-24 w-20 mr-2">
                      {item && (
                        <img
                          alt={item.name}
                    ...
                    <div id="productdesc" className="h-20 w-28 lg:w-40 xl:w-56 flex flex-col justify-evenly">
                  ...
                  <div id="quantity-price-subtotal" className="flex flex-row justify-between w-[240px] lg:w-[325px] items-center">
        ...
        <div id="cartsummary" className="w-full md:w-[330px] lg:w-[415px] mt-10 md:mt-0 rounded-lg p-4 border-black border">
