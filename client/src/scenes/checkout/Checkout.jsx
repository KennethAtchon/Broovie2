...
const Checkout = ({ handleNextStep, handlePrevStep }) => {
  ...
  return (
    ...
    <div id="divider" className='h-auto py-20 flex flex-col lg:flex-row items-center lg:items-start'>
      ...
      <div id="ordersummary" className='w-[415px] ml-8 mt-10 lg:ml-0 lg:mt-0'>
