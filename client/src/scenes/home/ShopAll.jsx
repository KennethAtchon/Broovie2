...
import shopall from "../../assets/shopallbg2.jpg";
...
const categories = [
  {key: 'homeaudio', value: 'Home Audio'},
  {key: 'portable', value: 'Portable Speaker'},
  {key: 'performance', value: 'High-Performance'},
  {key: 'theater', value: 'Home Theater'},
...
const Shop = ({ searchQuery = '' }) => {
  ...
  return (
    <div className="mx-0 md:mx-28">
      ...
      <div className='flex flex-col items-center sm:items-start sm:flex-row pt-16 '>
